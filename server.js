// ============================================================================
// SERVEUR LOCAL SÉNÉGAL - server.js SANS REDIRECTION HTTP → HTTPS
...
httpServer.listen(HTTP_PORT, HOST, () => {
  ...
  console.log(`📊 Dashboard HTTP: http://64.225.5.75:${HTTP_PORT}`);
...
if (httpsServer) {
  httpsServer.listen(HTTPS_PORT, HOST, () => {
    ...
    console.log(`📊 Dashboard HTTPS: https://64.225.5.75:${HTTPS_PORT}`);
